...
public class ShrinkBrick extends Brick {

	public ShrinkBrick(int x, int y) {
		// TODO Auto-generated constructor stub
		super(x, y);
		setColor(Color.web("96FCEB"));
	}
	...
	public void draw(GraphicsContext gc) {
		...
		gc.drawImage(RenderableHolder.shrinkPic, getX() + 2, getY(), 20, 20);
	...
	public void ability() {
		...
		if (Logic.getWallCount() == 0) {
			RenderableHolder.shrinkBrickBreak.play();
		}
		setDestroyed(true);
